...
layout(location = 3) in vec2 texCoord; // Attributo texture
...
void main() {
    ...
    //trasformare le normali nel vertice in esame nel sistema di coordinate di vists
    ...
    for (int i = 0; i < numLights; i++) {
        ...
        R[i] = reflect(-L[i], N);  //Costruisce la direzione riflessa di L rispesso alla normale
    }
